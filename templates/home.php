...
<div class="wrap">
  <div class="wrap__box">
    ...
    <?php $the_query = new WP_Query('showposts=2'); while ($the_query->have_posts()) : $the_query->the_post();?>
...
<div class="wrap">
  <div class="wrap__box wrap__box--shop">
    ...
    <?php $the_query = new WP_Query('showposts=4&category_name=shop'); while ($the_query->have_posts()) : $the_query->the_post();?>
