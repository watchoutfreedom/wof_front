...
<div class="wrap">
  ...
  <?php echo do_shortcode('[ajax_load_more id="8488605913" loading_style="infinite ring" post_type="post" posts_per_page="8" category="'.echo get_query_var('category_name');
